...
\title{
3 to 8 Decoder through AVR-GCC
}
...
\begin{table}[h]
    ...
    \begin{tabular}{| c |}
    \hline
    wget https://github.com/mygit-sampath-govardhan/fwc-iith-assignments\\/blob/8bf678297ca6e7ab7dcf3929290591d789f59a4f/Assignment-3\\/Assignment3-code.c\\
    \hline
    \end{tabular}
\end{table}
...
Here we can use same commands like DDR, PORT and many more which were used in Assembly and Ide.
 \section{Conclusion}
